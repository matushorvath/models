...
module zigbee_holder() {
    box_z = RELAY_WALL + RELAY_RISER_Z + RELAY_BOARD_Z + RELAY_LATCH_EXTRA_Z + RELAY_LATCH_LENGTH_Z;
    ...
    difference() {
        ...
        up(RELAY_WALL - DELTA)
            // The hight box_z is unnecessarily large, but it doesn't matter
            cuboid([RELAY_BOARD_X, RELAY_BOARD_Y, box_z], align = V_UP);
