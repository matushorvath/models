...
TOP_LVR_TOP_Y = BODY_Y; // 282 // TODO it's not BODY_Y, it's close to 285.xxx based on Sheet 30, Data List #2
...
module one_top_louvre_circ_left(center_z) {
    ...
    move(mid_back) // move to place
        zmove(TOP_LVR_R - TOP_LVR_WIDTH_Z / 2) // center the cylinder section
            difference() {
                cylinder(h = TOP_LVR_DEPTH, r = TOP_LVR_R, orient = LEFT, $fn=50);
